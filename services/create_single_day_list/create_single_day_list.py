...
def get_target_work_code9_list(positions_data, current_position_code3, current_game_time):
    position_code = [position_code for _, position_code in positions_data[current_game_time]['work_code9_list'].items()
...
def create_single_day_list(available_employees, positions_count, current_game_time, total_work_time, leader_count, positions_data, employee_skills):
    ...
    for current_position_code3, original_required_count in sorted_positions_code3:
        ...
        target_work_code9_list = get_target_work_code9_list(positions_data, current_position_code3, current_game_time) # current_position_code3に一致するポジションコードを取り出す
        
        # ポジションごとの必要な人数の数だけ以下の処理を繰り返す
        for current_target_work_code9 in target_work_code9_list:
            ...
            if best_employee:
                current_day_dict[current_target_work_code9] = best_employee
                ...
                current_day_dict[current_target_work_code9] = None
